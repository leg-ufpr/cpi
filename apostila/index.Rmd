...
img <- '# {-}\n\n<div><img src="./config/capa.png" width="350" alt="Controle de Processos Industriais" style="box-shadow: 0 1px 8px 0 rgba(0, 0, 0, 0.6);"/></div>'
cat(img, "\n")
```

\

**Atenção**: este material contém notas de aula da disciplina de CE 074
· Controle de Processos Industriais oferecido para o Curso de
